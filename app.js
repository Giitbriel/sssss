...
// Przewijanie sekcji przy kliknięciu w linki menu (opcjonalnie, scroll-behavior: smooth w CSS też to robi)
// menulinks.forEach(link => {
...
// Poczekaj, aż cała zawartość strony zostanie załadowana
    ...
    const animationDuration = 4000; // Czas trwania animacji jednego paska (w milisekundach) - zwiększono dla wolniejszego ruchu
